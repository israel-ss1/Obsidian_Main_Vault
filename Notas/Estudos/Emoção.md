...
Por estar ligado a um movimento ou uma decisão (realizar ou não o certo ou errado), a emoção está mais direcionada a consciência do que a percepção. Um sentimento é algo físico, é uma percepção que lhe gera um estado sensitivo. Uma emoção, embora esteja relacionado ao que sentimos é uma forma consciente de "mover para fora" o que estamos sentindo. A emoção é uma resposta a um [[Sentimento]]. 
